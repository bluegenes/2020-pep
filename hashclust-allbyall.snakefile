...
rule jpep_sourmash_compute:
    ...
    log: os.path.join(logs_dir, "sourmash", "{sample}_jpep_{scaled}_{encoding}_k{ksize}_compute.log")
    benchmark: os.path.join(logs_dir, "sourmash", "{sample}_jpep_{scaled}_{encoding}_k{ksize}_compute.benchmark")
