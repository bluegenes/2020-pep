#https://raw.githubusercontent.com/spacegraphcats/spacegraphcats/master/spacegraphcats/snakemake.py
import os
import yaml

def catlas_build(conf_file=None, catlas_base=None, radius=None, ksize=None):
